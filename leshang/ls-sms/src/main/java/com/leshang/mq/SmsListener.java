package com.leshang.mq;

import com.leshang.common.utils.JsonUtils;
import com.leshang.config.SmsProperties;
import com.leshang.utils.SmsUtils;
...
public class SmsListener {
    ...
    @RabbitListener(bindings = @QueueBinding(
            ...
            exchange = @Exchange(name = "ls.sms.exchange",type = ExchangeTypes.TOPIC),
            key = {"sms.verify.code"}
    ))
